...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.linear = nn.Linear(512 * block.expansion * width_mult, num_classes)
...
def ResNet50(**kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], width_mult=1, **kwargs)


def ResNet101(**kwargs):
    return ResNet(Bottleneck, [3, 4, 23, 3], width_mult=1, **kwargs)
